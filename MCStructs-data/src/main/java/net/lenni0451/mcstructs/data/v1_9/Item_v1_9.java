...
public class Item_v1_9 {
    ...
    public static Item_v1_9 getById(final int itemId) {
        for (Item_v1_9 item : ITEM_LIST) {
            if (item.itemId == itemId) return item;
        }
        return null;
    }

    public static Item_v1_9 getByName(final String name) {
        for (Item_v1_9 item : ITEM_LIST) {
    ...
    private Item_v1_9(final int itemId, final String name, final int maxStackSize, final int maxDamage, final boolean hasSubTypes, final int burnTime, final boolean isPotionIngredient) {
        this.itemId = itemId;
        this.name = name;
