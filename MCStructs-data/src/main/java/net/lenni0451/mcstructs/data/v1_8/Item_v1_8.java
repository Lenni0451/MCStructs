...
public class Item_v1_8 implements Item {
    ...
    public static Item_v1_8 getByName(final String name) {
        for (Item_v1_8 item : ITEM_LIST) {
    ...
    private Item_v1_8(final int itemId, final String name, final int maxStackSize, final int maxDamage, final boolean hasSubTypes, final int burnTime, final boolean isPotionIngredient) {
        this.itemId = itemId;
        this.name = name;
...
for (Object rawItem : itemRegistry) {
    ...
    out += "public static final Item_v1_8 ";
    out += name;
    out += " = new Item_v1_8(";
    out += id;
    out += ", \"";
