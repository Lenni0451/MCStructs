...
public class Block_v1_7 {
    ...
    public static Block_v1_7 getById(final int blockId) {
        for (Block_v1_7 block : BLOCK_LIST) {
            if (block.blockId() == blockId) return block;
        }
        return null;
    }

    public static Block_v1_7 getByName(final String name) {
        for (Block_v1_7 block : BLOCK_LIST) {
    ...
    private Block_v1_7(final int blockId, final String name, final boolean opaque, final float hardness, final float resistance) {
...
for (Object rawBlock : blockRegistry) {
    ...
    String name = blockRegistry.getNameForObject(block).split(":")[1];
    out += "public static final Block_v1_7 ";
    out += name;
    out += " = new Block_v1_7(" + id;
    out += ", \"" + name + "\"";
    out += ", " + block.opaque;
