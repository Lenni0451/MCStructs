...
public class Block_v1_8 {
    ...
    public static Block_v1_8 getByName(final String name) {
        for (Block_v1_8 block : BLOCK_LIST) {
    ...
    private Block_v1_8(final int blockId, final String name, final boolean opaque, final float hardness, final float resistance) {
...
for (Object rawBlock : blockRegistry) {
    ...
    out += "public static final Block_v1_8 ";
    out += name;
    out += " = new Block_v1_8(" + id;
    out += ", \"" + name + "\"";
