...
public class Item_v1_7 implements Item {
    ...
    private Item_v1_7(final int itemId, final String name, final int maxStackSize, final int maxDamage, final boolean hasSubTypes, final int burnTime, final boolean isPotionIngredient) {
        this.itemId = itemId;
        this.name = name;
