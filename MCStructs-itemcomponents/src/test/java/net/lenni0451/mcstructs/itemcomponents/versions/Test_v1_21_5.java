...
public class Test_v1_21_5 extends ItemComponentTest<ItemComponents_v1_21_5> {
    ...
    protected void register(ItemComponents_v1_21_5 registry) {
        ...
        register(registry.WOLF_VARIANT, Identifier.of("test"));
        register(registry.WOLF_SOUND_VARIANT, Identifier.of("test"));
        ...
        register(registry.PIG_VARIANT, Identifier.of("test"));
        register(registry.COW_VARIANT, Identifier.of("test"));
        register(registry.CHICKEN_VARIANT, Identifier.of("test"));
