...
public class Test_v1_21_5 extends ItemComponentTest<ItemComponents_v1_21_5> {
    ...
    protected void register(ItemComponents_v1_21_5 registry) {
        ...
        register(registry.COW_VARIANT, new CowVariant(new CowVariant.ModelAndTexture(CowVariant.ModelType.NORMAL, Identifier.of("test")), Arrays.asList(new CowVariant.SpawnCondition(Identifier.of("test"), 1))));
