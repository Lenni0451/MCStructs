...
public class Test_v1_21_2 {
    ...
    static {
        ...
        register(registry.CONSUMABLE, new Types_v1_21_2.Consumable(1.87F, Types_v1_21_2.Consumable.ItemUseAnimation.BOW, Either.left(Identifier.of("test")), false, Arrays.asList(Identifier.of("test1"), Identifier.of("test2"))));
        ...
        register(registry.EQUIPPABLE, new Types_v1_21_2.Equippable(Types_v1_21_2.EquipmentSlot.CHEST, Either.left(Identifier.of("test")), Identifier.of("test"), new Types_v1_20_5.TagEntryList(Arrays.asList(Identifier.of("test1"), Identifier.of("test2"))), false));
