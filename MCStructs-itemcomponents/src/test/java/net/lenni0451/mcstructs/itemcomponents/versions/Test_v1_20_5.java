...
//        register(registry.MAP_POST_PROCESSING, MapPostProcessing.LOCK);
        ...
        register(registry.BANNER_PATTERNS, Collections.singletonList(new BannerPattern(DyeColor.RED, Either.right(new BannerPattern.Pattern(Identifier.of("test"), "translation")))));
