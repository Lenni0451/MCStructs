...
public class ItemComponents_v1_21_4 extends ItemComponents_v1_21_2 {
    ...
    public final ItemComponent<Types_v1_21_2.Equippable> EQUIPPABLE = this.register("equippable", MapCodecMerger.codec(
            ...
            this.typeSerializers.soundEvent().mapCodec(Types_v1_21_2.Equippable.EQUIP_SOUND).optional().defaulted(Either.left(Identifier.of("item.armor.equip_generic"))), Types_v1_21_2.Equippable::getEquipSound,
            ...
            this.typeSerializers.tagEntryList(this.registryVerifier.entityTypeTag, this.registryVerifier.entityType).mapCodec(Types_v1_21_2.Equippable.ALLOWED_ENTITIES).optional().defaulted(null), Types_v1_21_2.Equippable::getAllowedEntities,
