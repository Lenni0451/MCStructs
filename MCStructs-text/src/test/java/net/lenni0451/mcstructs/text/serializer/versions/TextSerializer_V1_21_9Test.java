...
import static net.lenni0451.mcstructs.text.serializer.TextComponentSerializer.V1_21_9;

public class TextSerializer_V1_21_9Test extends TextSerializerTest {

    @Override
    protected TextComponent deserialize(String json) {
        return V1_21_9.deserializeParser(json);
    }

    @Override
    protected String serialize(TextComponent component) {
        return V1_21_9.serialize(component);
    }
