...
import static net.lenni0451.mcstructs.text.serializer.TextComponentSerializer.V26_2;

public class TextSerializer_V26_2Test extends TextSerializerTest {

    @Override
    protected TextComponent deserialize(String json) {
        return V26_2.deserializeParser(json);
    }

    @Override
    protected String serialize(TextComponent component) {
        return V26_2.serialize(component);
    }
