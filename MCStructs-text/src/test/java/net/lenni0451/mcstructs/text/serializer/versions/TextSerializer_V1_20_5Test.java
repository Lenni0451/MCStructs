...
import static net.lenni0451.mcstructs.text.serializer.TextComponentSerializer.V1_20_5;

public class TextSerializer_V1_20_5Test extends TextSerializerTest {

    @Override
    protected ATextComponent deserialize(String json) {
        return V1_20_5.deserializeParser(json);
    }

    @Override
    protected String serialize(ATextComponent component) {
        return V1_20_5.serialize(component);
    }
