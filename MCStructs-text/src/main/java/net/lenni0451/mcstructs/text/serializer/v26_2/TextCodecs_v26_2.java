...
public class TextCodecs_v26_2 {

    public static final Codec<TextComponent> TEXT = new LazyInitCodec<>(() -> {
        return Codec.recursive(thiz -> createCodec(thiz, StyleCodecs_v26_2.MAP_CODEC, ComponentType.values(), ComponentType::forComponent));
    });
    ...
    public static final MapCodec<ScoreComponent> SCORE_COMPONENT = MapCodecMerger.codec(
            Codec.STRING.converterVerified(verify(TextVerifier_v26_2.class, TextVerifier_v26_2::verifySelector, "Invalid selector")).mapCodec("name").required(), ScoreComponent::getName,
    ...
    public static final MapCodec<SelectorComponent> SELECTOR_COMPONENT = MapCodecMerger.mapCodec(
            Codec.STRING.converterVerified(verify(TextVerifier_v26_2.class, TextVerifier_v26_2::verifySelector, "Invalid selector")).mapCodec("selector").required(), SelectorComponent::getSelector,
    ...
    public static final MapCodec<NbtComponent> NBT_COMPONENT = MapCodecMerger.mapCodec(
            Codec.STRING.converterVerified(verify(TextVerifier_v26_2.class, TextVerifier_v26_2::verifyNbtPath, "Invalid nbt path")).mapCodec("nbt").required(), NbtComponent::getComponent,
    ...
    private enum NbtDataSourceType implements NamedType {
        ENTITY("entity", MapCodecMerger.mapCodec(
                Codec.STRING.converterVerified(verify(TextVerifier_v26_2.class, TextVerifier_v26_2::verifySelector, "Invalid selector")).mapCodec("entity").required(), EntityNbtSource::getSelector,
                EntityNbtSource::new
        )),
        BLOCK("block", MapCodecMerger.mapCodec(
                Codec.STRING.converterVerified(verify(TextVerifier_v26_2.class, TextVerifier_v26_2::verifyCoordinates, "Invalid coordinates")).mapCodec("block").required(), BlockNbtSource::getPos,
                BlockNbtSource::new
        )),
