...
public class TextCodecs_v1_21_5 {
    ...
    public static final Codec<TextComponent> TEXT = new LazyInitCodec<>(() -> {
        return Codec.recursive(thiz -> createCodec(thiz, StyleCodecs_v1_21_5.MAP_CODEC, ComponentType.values(), ComponentType::forComponent));
    });
    ...
    public static final MapCodec<SelectorComponent> SELECTOR_COMPONENT = MapCodecMerger.mapCodec(
            Codec.STRING.converterVerified(verify(TextVerifier_v1_21_5.class, TextVerifier_v1_21_5::verifySelector, "Invalid selector")).mapCodec("selector").required(), SelectorComponent::getSelector,
