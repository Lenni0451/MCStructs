    ...
    public ATextComponent deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        if (json.isJsonPrimitive()) {
            ...
            if (rawComponent.has("text")) {
                ...
                component = new ScoreComponent(this.getString(score, "name"), this.getString(score, "objective"));
                if (score.has("value")) ((ScoreComponent) component).setValue(this.getString(score, "value"));
            } else if (rawComponent.has("selector")) {
                component = new SelectorComponent(this.getString(rawComponent, "selector"));
            } else {
